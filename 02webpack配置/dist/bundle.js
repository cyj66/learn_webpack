...
//commonjs模块化规范
const {add,mul}=__webpack_require__(1);   //打包的时候打包该入口文件就可，会自动识别有没有其他依赖文件
console.log(add(20,30));
console.log(mul(20,30));

//ES6模块化规范

console.log(__WEBPACK_IMPORTED_MODULE_0__info_js__["b" /* name */]);
console.log(__WEBPACK_IMPORTED_MODULE_0__info_js__["a" /* height */]);
